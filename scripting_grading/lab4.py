...
key = dict(
    ...
    q11 = dict(entrytype='var', pts=4, auto=True, answers=[('20.1', 'max', ''), ('23.4', '-2', 'That is the mean for all the cars.')],
    ...
    q16f = dict(entrytype='var', pts=1, auto=True, answers=["[1, 2, 3]", "1,2,3"], question="List"),
