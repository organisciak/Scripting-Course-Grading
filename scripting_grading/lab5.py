...
key = dict(
    ...
    q5 = dict(entrytype='var', pts=4, auto=True, answers=[['Film-Noir', 'Musical', 'War']],
              question="Select the three most out-of-vogue film genres, by median release year."),
    q6 = dict(entrytype='var', pts=4, auto=True,
